...
export function KakaoFloatingButton() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-24 right-4 z-40 inline-flex items-center gap-2 rounded-full border border-[#E6CB00] bg-[#FEE500] px-4 py-3 text-sm font-semibold text-[#191919] shadow-[0_18px_30px_rgba(25,25,25,0.16)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_38px_rgba(25,25,25,0.2)] sm:bottom-6 sm:right-6"
